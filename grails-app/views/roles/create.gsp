            ...
            <g:form action="save" >
                <div class="dialog">
                    <table>
                        <tbody>
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="channel.name.label" default="Nombre Rol" />:</td>
                            <td valign="top" class="value">
                            	<g:textField name="nombre" value="${rol?.nombre}" />
                            </td>
                        </tr>
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="a" default="Descripcion" />:</td>
                            <td valign="top" class="value">
                            	<g:textField name="descripcion" value="${rol?.descripcion}" />
                            </td>    
                        </tr>
                        </tbody>
                    </table>
